...
int main(int argc, const char *argv[])
{
    ...
    case 0:
        { 
			...
			//CORRECTNESS ANNOTATIONS
			SetAdaptor<TransList> set(testSize, numThread + 1, tranSize, keyRange, recovery); TesterRecover(numThread, testSize, tranSize, keyRange, insertion, deletion, set, recovery); 
		}
        break;
    // case 1:
